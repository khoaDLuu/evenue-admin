        ...
        >
          <li class="border-b border-gray-200 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-gray-50" to="#0" @click="dropdownOpen = false">
              <span class="block text-sm mb-2">📣 <span class="font-medium text-gray-800">Welcome to Evenue's admin site!</span></span>
              <span class="block text-xs font-medium text-gray-400">{{ new Date().toLocaleString("en") }}</span>
            </router-link>
          </li>
        </ul>
      </div>
